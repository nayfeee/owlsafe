...
const dataEnquiries = [
  ...
  "Historic or older home refurbishment",
  "Town centre shop and hospitality works",
  "Commercial premises management",
  "School and community building works",
  "Business unit and warehouse surveys",
  "Garage or outbuilding checks",
  "Heating, rewiring and service upgrades",
  "Demolition or structural strip-out",
  "Sampling of suspect materials"
];
const buildingTypes = [
  {
    "title": "Historic market town buildings",
    "text": "Wetherby includes older town centre properties and commercial premises where later fit-outs and refurbishments may have introduced asbestos materials."
  },
  {
    "title": "Larger homes and riverside properties",
    "text": "Larger houses, older homes and extended properties may contain asbestos in ceilings, floors, services, garages, loft spaces, outbuildings and later alterations."
  },
  {
    "title": "Hospitality, retail and office premises",
    "text": "Restaurants, pubs, shops, offices and mixed-use premises may need surveys before fit-outs, maintenance, landlord works or changes of use."
  },
  {
    "title": "Business units, schools and managed buildings",
    "text": "Commercial, educational and managed premises, including nearby business and industrial areas, may require asbestos management information or pre-works refurbishment survey information."
  }
];
const surveyReasons = [
  {
    "title": "Property purchase or sale",
    "href": "/asbestos-surveys-leeds",
    "text": "Buyers may arrange surveys before purchasing older homes, commercial premises, converted buildings or properties with known asbestos concerns."
  },
  {
    "title": "Refurbishment or fit-out",
    "href": "/asbestos-refurbishment-survey-leeds",
    "text": "Refurbishment surveys may be required before work disturbs ceilings, walls, floors, services, shop interiors, garages or plant areas."
  },
  {
    "title": "Commercial asbestos management",
    "href": "/asbestos-management-survey-leeds",
    "text": "Management surveys and reinspections support duty holders responsible for shops, offices, schools, hospitality premises and managed buildings."
  },
  {
    "title": "Demolition or strip-out",
    "href": "/asbestos-demolition-survey-leeds",
    "text": "Demolition surveys may be needed before full or partial demolition, structural strip-out, garage removal or major redevelopment."
  }
];
...
const nearbyAreas = [
  {
    "title": "Boston Spa",
    "text": "Older homes, commercial premises, schools and property purchase enquiries."
  },
  {
    "title": "Collingham",
    "text": "Larger homes, extensions, garages and refurbishment surveys."
  },
  {
    "title": "Thorp Arch",
    "text": "Business units, industrial premises, warehouses and planned works."
  },
  {
    "title": "Bramham",
    "text": "Older homes, outbuildings, rural properties and renovation enquiries."
  },
  {
    "title": "Walton",
    "text": "Residential properties, extensions, garages and local maintenance works."
  },
  {
    "title": "East Keswick",
    "text": "Larger homes, older properties and pre-purchase surveys."
  }
];
const faqsData = [
  {
    "q": "Do Wetherby town centre buildings need asbestos surveys?",
    "a": "Commercial or mixed-use buildings built or refurbished before 2000 may need asbestos information before fit-outs, landlord works, maintenance or refurbishment."
  },
  {
    "q": "Can surveys be arranged for hospitality premises?",
    "a": "Yes. Survey enquiries can be arranged for pubs, restaurants, cafes, hotels and other hospitality premises where works or duty holder responsibilities apply."
  },
  {
    "q": "What survey is needed before renovating an older home?",
    "a": "If the work is intrusive, a refurbishment survey is usually the relevant survey type. Scope depends on the rooms, services and materials affected."
  },
  {
    "q": "Are nearby business units covered?",
    "a": "Yes. Survey enquiries can be arranged for business units, warehouses, managed buildings and commercial premises around Wetherby and nearby areas."
  },
  {
    "q": "How much does an asbestos survey cost in Wetherby?",
...
const processSteps = [
  ...
  [
    ...
    "A qualified asbestos surveyor covering Wetherby can advise whether you are likely to need a management survey, refurbishment survey, demolition survey or reinspection based on how the building is used and what work is planned.",
  ],
  [
    "03",
...
export default function WetherbyPage() {
  return (
    <main className="min-h-screen bg-[#f6f7f3] text-slate-800">
      ...
      <Hero
        title="Asbestos Survey Wetherby"
        intro="Arrange asbestos survey enquiries across Wetherby, Boston Spa, Collingham and nearby North East Leeds areas for homeowners, landlords, commercial premises, hospitality buildings, schools, business units and planned refurbishment work. Work with qualified asbestos surveyors and receive clear, compliance-focused reporting."
        mobileIntro="Arrange asbestos survey enquiries across Wetherby, Boston Spa and Collingham for homes, landlords, commercial premises and planned works."
        desktopImage="/images/asbestos-surveys-hero.png"
        imageAlt="Asbestos survey Wetherby"
        primaryHref="/quote"
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto grid max-w-[1120px] gap-12 md:grid-cols-[0.58fr_0.42fr]">
          <Fade>
            <InnerTitle
              center={false}
              eyebrow="LS22 / NORTH EAST LEEDS asbestos survey enquiries"
              intro={<p>Wetherby includes a historic market town centre, riverside properties, older homes, commercial premises, hospitality buildings, schools, larger houses and nearby business and industrial areas. Survey enquiries can range from home renovations to commercial compliance and pre-purchase due diligence.</p>}
            >
              Asbestos Surveys for Wetherby Properties
            </InnerTitle>

            <div className="space-y-5 text-[14px] leading-7 text-slate-600">
              <p>Across Wetherby, Boston Spa, Collingham, Thorp Arch and Bramham, asbestos survey enquiries are commonly linked to older homes, town centre commercial premises, hospitality venues, schools, managed buildings, larger properties and refurbishment projects.</p>
              <p>Wetherby’s long history as a market town on the River Wharfe, with properties around the town centre, Wetherby Bridge, the racecourse area, riverside settings and nearby villages, means some buildings include older fabric alongside later twentieth-century alterations, extensions and fit-outs.</p>
              <p>Nearby Thorp Arch and surrounding business areas add a different type of survey demand, including warehouses, workshops, offices, light industrial units, storage buildings and managed commercial premises where asbestos management information may be needed before works.</p>
              <p>Where buildings were constructed or refurbished before 2000, asbestos-containing materials may be present in textured coatings, insulation boards, service cupboards, old floor tiles, pipe boxing, garages, roof sheets, soffits, plant rooms and ceiling voids.</p>
              <p>OwlSafe helps connect homeowners, buyers, landlords, managing agents, contractors and commercial property owners with qualified asbestos surveyors covering Wetherby and nearby North East Leeds locations.</p>
            </div>
          ...
          <Fade delay={0.06}>
            <div className="border border-[#d8e2d6] bg-[#f6f7f3] p-7 shadow-sm clip-section-bl">
              ...
              <h3 className="mt-5 text-[26px] font-semibold leading-tight text-[#1b3a1f]">
                Common Wetherby enquiries
              </h3>

              <div className="mt-6 grid gap-3">
                {dataEnquiries.map((item) => (
                  <div
                    key={item}
      ...
      <section className="bg-[#f6f7f3] px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          <InnerTitle
            ...
            intro={<p>Survey scope depends on the building, how it has been altered and whether the planned work is intrusive. These are some of the property types commonly linked with Wetherby asbestos survey enquiries.</p>}
          >
            Property Types Commonly Surveyed in Wetherby
          </InnerTitle>
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          <InnerTitle
            ...
            intro={<p>Different survey types are used for different situations. The right survey depends on whether the building is occupied, being refurbished, demolished or monitored as part of an asbestos management plan.</p>}
          >
            Common Reasons for Asbestos Surveys in Wetherby
          </InnerTitle>
        ...
        <div className="mx-auto grid max-w-[1120px] gap-12 md:grid-cols-[0.58fr_0.42fr]">
          <Fade>
            <InnerTitle
              ...
              intro={<p>The materials below are examples of suspect asbestos-containing materials that may be encountered in pre-2000 buildings. A surveyor determines the relevant inspection scope based on the property and proposed works.</p>}
            >
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          <InnerTitle intro={<p>The process is designed to be straightforward. Provide the property details and planned works, then a qualified asbestos surveyor covering Wetherby can advise on the most suitable survey type.</p>}>
            How Asbestos Surveys Work in Wetherby
          </InnerTitle>
      ...
      <section className="bg-[#eef4eb] px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          <InnerTitle
            ...
            intro={<p>Survey enquiries can also be arranged in nearby Leeds areas. Use the links below to explore other local survey pages or return to the main areas hub.</p>}
          >
            Asbestos Surveys Near Wetherby
          </InnerTitle>
        ...
        <div className="relative z-10 mx-auto max-w-[1120px]">
          <div className="max-w-[760px]">
            <InnerTitle center={false}>
              Frequently Asked Questions About Asbestos Surveys in Wetherby
            </InnerTitle>
            ...
            <div className="mt-8 overflow-hidden border border-[#d8e2d6] bg-white/86 shadow-[0_20px_50px_rgba(27,58,31,0.08)] backdrop-blur-sm">
              {faqsData.map((item, i) => (
                <details key={item.q} open={i === 0} className="group border-b border-[#d8e2d6] last:border-0">
                  ...
                  <div className="px-6 pb-6">
                    <p className="max-w-[90%] text-[14px] leading-7 text-slate-600">{item.a}</p>
                  </div>
                </details>
              ))}
            </div>
            ...
            <div className="mt-8 overflow-hidden border border-[#d8e2d6] bg-[#1b3a1f] p-7 text-white shadow-[0_20px_50px_rgba(27,58,31,0.12)] clip-section-bl">
              <h3 className="text-[28px] font-semibold leading-tight">Need an Asbestos Survey in Wetherby?</h3>
              <p className="mt-4 max-w-[620px] text-[14px] leading-7 text-white/78">
                Arrange asbestos survey enquiries for homes, landlords, commercial premises and refurbishment projects across Wetherby and nearby areas including Boston Spa, Collingham, Thorp Arch, Bramham and Walton.
              </p>
              <div className="mt-7 grid max-w-[250px] gap-3">
                <Button ghost clipped={false} href="/areas-we-cover">View Areas We Cover</Button>
      ...
      <section className="bg-[#1b3a1f] px-5 py-16 md:py-20">
        <div className="mx-auto flex max-w-[1120px] flex-col justify-between gap-8 text-white md:flex-row md:items-center">
          <div>
            <h2 className="mt-3 text-[34px] font-semibold leading-tight tracking-[-0.04em] md:text-[46px]">Need an Asbestos Survey in Wetherby?</h2>
            <p className="mt-4 max-w-[680px] text-[14px] leading-7 text-white/74">
              Request a quote for asbestos survey enquiries across Wetherby, Boston Spa, Collingham, Thorp Arch, Bramham and Walton and wider Leeds.
            </p>
          </div>
          <div className="flex w-full flex-col gap-3 md:w-auto">
            <Button ghost clipped={false} href="/areas-we-cover" className="w-full border-white text-white hover:bg-white hover:text-[#1b3a1f] md:w-[230px]">View areas we cover</Button>
