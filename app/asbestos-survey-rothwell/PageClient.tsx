...
const dataEnquiries = [
  ...
  "Commercial premises and shop works",
  "Landlord and managed property duties",
  "School, church or community building works",
...
const buildingTypes = [
  {
    "title": "Older homes and historic town centre buildings",
    "text": "Rothwell contains older properties and commercial premises where later refurbishments may have introduced asbestos into ceilings, floors, services, loft spaces, extensions and rear additions."
  },
  {
    "title": "Post-war housing and estates",
    "text": "Post-war and later twentieth-century housing may contain asbestos materials in textured coatings, floor tiles, service cupboards, garages, cement products and heating upgrade areas."
  },
  {
    "title": "Commercial, school and community premises",
    "text": "Shops, schools, churches, offices and managed buildings may need asbestos information before maintenance, refurbishment, fit-outs or compliance-led works."
  },
  {
    "title": "Mining-linked and industrial settings",
    "text": "Former industrial and mining-linked areas around Rothwell and nearby South East Leeds may include workshops, outbuildings, storage areas and commercial premises where survey scope should be carefully defined."
  }
];
const surveyReasons = [
  {
    ...
    "text": "Buyers may arrange surveys before purchasing older homes, extended properties, commercial premises or mixed-use buildings."
  },
  {
    "title": "Refurbishment or maintenance",
    "href": "/asbestos-refurbishment-survey-leeds",
    "text": "Refurbishment surveys may be required before works disturb ceilings, walls, floors, services, garages, lofts or outbuildings."
  },
  {
    "title": "Duty holder responsibilities",
    "href": "/asbestos-management-survey-leeds",
    "text": "Management surveys and reinspections support landlords, commercial owners and those responsible for non-domestic premises."
  },
  {
    "title": "Demolition or structural works",
    "href": "/asbestos-demolition-survey-leeds",
    "text": "Demolition surveys may be needed before full demolition, partial demolition, garage removal, extension removal or structural strip-out."
  }
];
...
const nearbyAreas = [
  {
    "title": "Oulton",
    "text": "Older homes, larger properties, commercial premises and refurbishment enquiries."
  },
  {
    "title": "Woodlesford",
    "text": "Residential properties, local businesses, canal-side areas and planned works."
  },
  {
    "title": "Lofthouse",
    "text": "Homes, former mining-linked areas, garages and commercial units."
  },
  {
    "title": "Robin Hood",
    "text": "Residential properties, schools, managed buildings and maintenance projects."
  },
  {
    "title": "Methley",
    "text": "Older homes, rural properties, outbuildings and property purchase surveys."
  },
  {
    "title": "Stourton",
    "text": "Commercial, industrial and warehouse premises with refurbishment or management needs."
  }
];
const faqsData = [
  {
    "q": "Do Rothwell homes need asbestos surveys before renovation?",
    "a": "If the property was built or refurbished before 2000 and planned work will disturb materials, a refurbishment survey may be required before work begins."
  },
  {
    "q": "Can surveys include garages and outbuildings?",
    "a": "Yes. Garages and outbuildings are often included where roof sheets, cement panels, soffits or internal linings may be affected by work or demolition."
  },
  {
    "q": "What survey is needed for a commercial property?",
    "a": "The correct survey depends on whether the building is being managed, refurbished, demolished or reinspected. A surveyor can advise from the building use and planned work."
  },
  {
    "q": "Are schools and churches covered?",
    "a": "Yes. Survey enquiries can be arranged for schools, churches, community premises and managed non-domestic buildings."
  },
  {
    "q": "How much does an asbestos survey cost in Rothwell?",
...
export default function RothwellPage() {
  return (
    <main className="min-h-screen bg-[#f6f7f3] text-slate-800">
      ...
      <Hero
        title="Asbestos Survey Rothwell"
        intro="Arrange asbestos survey enquiries across Rothwell, Oulton, Woodlesford and nearby South East Leeds areas for homeowners, landlords, commercial premises, schools, churches, older buildings and planned refurbishment work. Work with qualified asbestos surveyors and receive clear, compliance-focused reporting."
        mobileIntro="Arrange asbestos survey enquiries across Rothwell, Oulton and Woodlesford for homes, landlords, commercial premises and planned works."
        desktopImage="/images/asbestos-surveys-hero.png"
        imageAlt="Asbestos survey Rothwell"
        primaryHref="/quote"
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto grid max-w-[1120px] gap-12 md:grid-cols-[0.58fr_0.42fr]">
          <Fade>
            <InnerTitle
              center={false}
              eyebrow="LS26 / SOUTH EAST LEEDS asbestos survey enquiries"
              intro={<p>Rothwell includes a historic town centre, older housing, post-war developments, former mining-linked areas, commercial premises, churches, schools and managed buildings. Survey enquiries often need to reflect both historic fabric and later twentieth-century alterations.</p>}
            >
              Asbestos Surveys for Rothwell Properties
            </InnerTitle>

            <div className="space-y-5 text-[14px] leading-7 text-slate-600">
              <p>Across Rothwell, Oulton, Woodlesford, Lofthouse and Robin Hood, asbestos survey enquiries are commonly linked to older homes, property purchases, commercial premises, schools, churches, landlord buildings, garage removals and refurbishment projects.</p>
              <p>Rothwell has a long local history shaped by its historic core, Rothwell Parish Church, Rothwell Castle remains, Springhead Park, later housing growth and coal mining activity in the wider area. Buildings may include a mix of older construction, post-war materials, later extensions, modern fit-outs and outbuildings.</p>
              <p>Where properties were constructed or refurbished before 2000, asbestos-containing materials may be present in textured coatings, insulation boards, old floor tiles, service ducts, pipe boxing, garage roofs, soffits, boiler areas, ceiling voids and outbuildings.</p>
              <p>OwlSafe helps connect homeowners, buyers, landlords, managing agents, contractors, developers and commercial property owners with qualified asbestos surveyors covering Rothwell and nearby South East Leeds locations.</p>
            </div>
      ...
      <section className="bg-[#f6f7f3] px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          <InnerTitle
            ...
            intro={<p>Survey scope depends on the building, how it has been altered and whether the planned work is intrusive. These are some of the property types commonly linked with Rothwell asbestos survey enquiries.</p>}
          >
            Property Types Commonly Surveyed in Rothwell
          </InnerTitle>
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          ...
          >
            Common Reasons for Asbestos Surveys in Rothwell
          </InnerTitle>
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          <InnerTitle intro={<p>The process is designed to be straightforward. Provide the property details and planned works, then a qualified asbestos surveyor covering Rothwell can advise on the most suitable survey type.</p>}>
            How Asbestos Surveys Work in Rothwell
          </InnerTitle>
      ...
      <section className="bg-[#eef4eb] px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          ...
          >
            Asbestos Surveys Near Rothwell
          </InnerTitle>
        ...
        <div className="relative z-10 mx-auto max-w-[1120px]">
          <div className="max-w-[760px]">
            <InnerTitle center={false}>
              Frequently Asked Questions About Asbestos Surveys in Rothwell
            </InnerTitle>
            ...
            <div className="mt-8 overflow-hidden border border-[#d8e2d6] bg-[#1b3a1f] p-7 text-white shadow-[0_20px_50px_rgba(27,58,31,0.12)] clip-section-bl">
              <h3 className="text-[28px] font-semibold leading-tight">Need an Asbestos Survey in Rothwell?</h3>
      ...
      <section className="bg-[#1b3a1f] px-5 py-16 md:py-20">
        <div className="mx-auto flex max-w-[1120px] flex-col justify-between gap-8 text-white md:flex-row md:items-center">
          <div>
            <h2 className="mt-3 text-[34px] font-semibold leading-tight tracking-[-0.04em] md:text-[46px]">Need an Asbestos Survey in Rothwell?</h2>
            <p className="mt-4 max-w-[680px] text-[14px] leading-7 text-white/74">
              Request a quote for asbestos survey enquiries across Rothwell, Oulton, Woodlesford, Lofthouse, Robin Hood and Methley and wider Leeds.
            </p>
          </div>
