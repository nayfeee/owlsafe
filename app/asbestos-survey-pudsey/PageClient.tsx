...
const buildingTypes = [
  {
    title: "Older terraces and stone-built homes",
    text: "Pudsey has a strong mix of traditional terraces, stone-built homes and older family properties. Survey enquiries often relate to ceilings, floor layers, roof spaces, service boxing, garages, extensions and later refurbishment materials.",
  },
  {
    title: "Former mills and industrial buildings",
    text: "Pudsey and nearby Farsley have a history of textile and mill-related buildings. Older commercial and former industrial premises may require careful survey scoping around roof voids, plant areas, service routes, floor layers and later fit-outs.",
  },
  {
    title: "Town centre shops and mixed-use premises",
    text: "Retail units, offices, hospitality spaces and mixed-use buildings around Pudsey town centre may need surveys before fit-outs, refurbishment, tenant changes, landlord works or maintenance.",
  },
  {
    title: "Managed flats and rental properties",
    text: "Converted buildings, rental properties and managed residential premises may include communal areas, basements, risers, service cupboards, roof voids and shared spaces where asbestos management information may be required.",
  },
];
...
const surveyReasons = [
  {
    ...
    text: "Buyers may arrange asbestos surveys before purchasing older homes, converted buildings, commercial premises or properties with previous refurbishment work.",
  },
  {
    title: "Renovation or refurbishment work",
    href: "/asbestos-refurbishment-survey-leeds",
    text: "Refurbishment surveys may be required before intrusive works to kitchens, bathrooms, ceilings, floors, walls, loft spaces, garages, extensions or service routes.",
  },
  {
    title: "Landlord and duty holder responsibilities",
    href: "/asbestos-management-survey-leeds",
    text: "Management surveys help landlords, business owners and duty holders understand asbestos risks in occupied premises and shared or non-domestic areas.",
  },
  {
    title: "Demolition, strip-out or garage removal",
    href: "/asbestos-demolition-survey-leeds",
    text: "Demolition surveys may be needed before full demolition, partial demolition, garage removal, structural strip-out or redevelopment work.",
  },
];
...
const nearbyAreas = [
  {
    title: "Farsley",
    text: "Former mill buildings, independent commercial premises, terraces and refurbishment enquiries.",
  },
  {
    title: "Calverley",
    text: "Older homes, stone properties, larger family houses and property purchase surveys.",
  },
  {
    title: "Stanningley",
    text: "Mixed residential, commercial and light industrial premises requiring survey scoping.",
  },
  {
    title: "Fulneck",
    text: "Historic buildings, older properties, listed settings and careful pre-works planning.",
  },
  {
    title: "Bramley",
    text: "Terraces, rental properties, commercial premises and planned maintenance works.",
  },
  {
    title: "Rodley",
    text: "Canal-side properties, converted spaces, homes, outbuildings and small commercial premises.",
  },
];

const faqsData = [
  {
    q: "Do older homes in Pudsey need asbestos surveys?",
    a: "Not automatically, but homes built or refurbished before 2000 may contain asbestos-containing materials. A survey is commonly arranged before intrusive refurbishment, purchase due diligence or demolition work.",
  },
  {
    q: "Can former mills or workshops in Pudsey contain asbestos?",
    a: "Yes, older commercial and former industrial buildings can include asbestos in roof spaces, service routes, boards, floor layers, pipe insulation, plant areas and later fit-out materials.",
  },
  {
    q: "What survey is needed before renovating a house in Pudsey?",
    a: "If the works will disturb walls, ceilings, floors, services, garages or extensions in a pre-2000 property, a refurbishment survey may be required before work starts.",
  },
  {
    q: "Can commercial premises in Pudsey be surveyed?",
    a: "Yes. Survey enquiries can be arranged for shops, offices, hospitality premises, workshops, warehouses, managed buildings and mixed-use commercial properties.",
  },
  {
    q: "How much does an asbestos survey cost in Pudsey?",
...
const processSteps = [
  ...
  [
    ...
    "A qualified asbestos surveyor covering Pudsey can advise whether you are likely to need a management survey, refurbishment survey, demolition survey or reinspection based on how the building is used and what work is planned.",
  ],
  [
    "03",
...
export default function PudseyPage() {
  return (
    <main className="min-h-screen bg-[#f6f7f3] text-slate-800">
      ...
      <Hero
        title="Asbestos Survey Pudsey"
        intro="Arrange asbestos survey enquiries across Pudsey, Farsley, Calverley, Stanningley and nearby West Leeds areas for homeowners, landlords, commercial premises, older buildings and planned refurbishment work. Work with qualified asbestos surveyors and receive clear, compliance-focused reporting."
        mobileIntro="Arrange asbestos survey enquiries across Pudsey, Farsley and Calverley for homes, landlords, commercial premises and planned works."
        desktopImage="/images/asbestos-surveys-hero.png"
        imageAlt="Asbestos survey Pudsey"
        primaryHref="/quote"
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto grid max-w-[1120px] gap-12 md:grid-cols-[0.58fr_0.42fr]">
          <Fade>
            <InnerTitle
              center={false}
              eyebrow="LS28 / WEST LEEDS asbestos survey enquiries"
              intro={
                <p>
                  Pudsey and nearby West Leeds areas include older terraces, stone-built homes, former industrial buildings, mill-related premises, suburban housing, retail units, workshops and managed buildings. Many properties have been extended, modernised or adapted during periods when asbestos-containing materials were still commonly used.
                </p>
              }
            >
              Asbestos Surveys for Pudsey Properties
            </InnerTitle>

            <div className="space-y-5 text-[14px] leading-7 text-slate-600">
              <p>
                Across Pudsey, Farsley, Calverley, Stanningley and Fulneck, asbestos survey enquiries are commonly linked to property purchases, home refurbishments, rental properties, commercial premises, former workshop spaces, garage works and landlord-managed buildings.
              </p>
              <p>
                Pudsey has a strong industrial and textile heritage, and nearby Farsley includes former mill buildings and commercial conversions. These types of buildings may contain a mixture of older fabric, later fit-outs, service alterations, fire protection materials, roof voids and plant or storage areas that need careful survey scoping.
              </p>
              <p>
                In residential properties, asbestos-containing materials may have been introduced during later upgrades from the 1950s through to the late 1990s. Materials may be found in textured ceilings, floor tiles, pipe boxing, garages, extensions, roofline products, service cupboards, boiler areas and outbuildings.
              </p>
              <p>
                OwlSafe helps connect homeowners, buyers, landlords, managing agents, contractors and business owners with qualified asbestos surveyors covering Pudsey and nearby West Leeds locations.
              </p>
            </div>
      ...
      <section className="bg-[#f6f7f3] px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          <InnerTitle
            ...
            intro={
              <p>
                Survey scope depends on the building, its age, how it has been altered and whether planned work is intrusive. These are some of the property types commonly linked with Pudsey asbestos survey enquiries.
              </p>
            }
          >
            Property Types Commonly Surveyed in Pudsey
          </InnerTitle>
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          ...
          >
            Common Reasons for Asbestos Surveys in Pudsey
          </InnerTitle>
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          <InnerTitle
            intro={
              <p>
                The process is designed to be straightforward. Provide the property details and planned works, then a qualified asbestos surveyor covering Pudsey can advise on the most suitable survey type.
              </p>
            }
          >
            How Asbestos Surveys Work in Pudsey
          </InnerTitle>
        ...
        <div className="relative z-10 mx-auto max-w-[1120px]">
          <div className="max-w-[760px]">
            <InnerTitle center={false}>
              Frequently Asked Questions About Asbestos Surveys in Pudsey
            </InnerTitle>
            ...
            <div className="mt-8 overflow-hidden border border-[#d8e2d6] bg-[#1b3a1f] p-7 text-white shadow-[0_20px_50px_rgba(27,58,31,0.12)] clip-section-bl">
              <h3 className="text-[28px] font-semibold leading-tight">
                Need an Asbestos Survey in Pudsey?
              </h3>
              <p className="mt-4 max-w-[620px] text-[14px] leading-7 text-white/78">
                Arrange asbestos survey enquiries for homes, landlords, commercial premises and refurbishment projects across Pudsey and nearby areas including Farsley, Calverley, Stanningley, Fulneck and Bramley.
              </p>
        ...
        <div className="mx-auto flex max-w-[1120px] flex-col justify-between gap-8 text-white md:flex-row md:items-center">
          <div>
            ...
            <p className="mt-4 max-w-[680px] text-[14px] leading-7 text-white/74">
              Request a quote for asbestos survey enquiries across Pudsey, Farsley, Calverley, Stanningley, Fulneck, Bramley and wider Leeds.
            </p>
          </div>
