...
const buildingTypes = [
  {
    title: "Student rentals and HMOs",
    text: "Headingley has a high concentration of rental and shared accommodation. Asbestos survey enquiries often relate to maintenance, rewiring, fire safety works, kitchen and bathroom replacements, roof spaces, ceiling finishes and older service routes.",
  },
  {
    title: "Victorian and Edwardian terraces",
    text: "Older terraces around Headingley, Hyde Park, Burley and Woodhouse may contain asbestos materials introduced during later refurbishments, including textured coatings, floor tiles, boxing, insulation board and ceiling void materials.",
  },
  {
    title: "Converted flats and larger houses",
    text: "Large houses converted into flats or multi-occupied accommodation may include communal areas, service risers, basements, loft spaces and shared plant or meter cupboards where asbestos management information may be needed.",
  },
  {
    title: "Retail, pubs and local commercial units",
    text: "Shops, caf\u00e9s, bars, offices and hospitality premises may need surveys before fit-out, strip-out, extraction works, suspended ceiling alterations or intrusive maintenance.",
  },
];

const surveyReasons = [
  {
    title: "Landlord and HMO maintenance",
    href: "/asbestos-management-survey-leeds",
    text: "Management surveys can help landlords and duty holders identify asbestos risks in occupied properties, communal areas and premises requiring ongoing maintenance.",
  },
  {
    title: "Student property refurbishment",
    href: "/asbestos-refurbishment-survey-leeds",
    text: "Refurbishment surveys may be needed before rewiring, bathroom works, kitchen replacements, ceiling works, fire upgrades or intrusive repairs.",
  },
  {
    title: "Shop or hospitality fit-out",
    href: "/asbestos-refurbishment-survey-leeds",
    text: "Commercial units may need survey information before tenant fit-outs, strip-outs, back-of-house alterations, signage works or extraction changes.",
  },
  {
    title: "Garage or outbuilding removal",
    href: "/asbestos-demolition-survey-leeds",
    text: "Older garages and outbuildings may include asbestos cement roofing, panels or soffits that should be identified before removal or demolition.",
  },
];

const commonMaterials = [
  "Textured coatings to ceilings and walls",
  "Asbestos insulating board in boxing, risers or cupboards",
  "Old floor tiles and bitumen adhesive",
  "Pipe insulation and service duct materials",
  "Ceiling void and partition materials",
  "Garage roof sheets, soffits and external cement products",
  "Basement, cellar and plant area materials",
  "Fire protection boards around services"
];

const nearbyAreas = [
  {
    title: "Hyde Park",
    text: "Terraced housing, student accommodation, converted flats and rental refurbishment enquiries.",
  },
  {
    title: "Burley",
    text: "Older terraces, commercial units, landlord works and properties close to Kirkstall Road.",
  },
  {
    title: "Kirkstall",
    text: "Mixed housing, older commercial buildings, apartments and refurbishment projects.",
  },
  {
    title: "Woodhouse",
    text: "Student properties, older residential streets, institutional buildings and managed premises.",
  },
  {
    title: "Meanwood",
    text: "Residential properties, larger homes, local commercial units and landlord enquiries.",
  },
  {
    title: "Chapel Allerton",
    text: "Nearby North Leeds homes, commercial units, larger properties and refurbishment works.",
  },
];

const faqsData = [
  {
    q: "Do landlords in Headingley need asbestos surveys?",
    a: "Landlords may need asbestos information where they control non-domestic areas, shared spaces, managed premises or where maintenance and refurbishment work could disturb suspect materials. For occupied buildings, a management survey is commonly used.",
  },
  {
    q: "Do student houses need asbestos checks before refurbishment?",
    a: "If a student rental or HMO was built or refurbished before 2000 and intrusive work is planned, a refurbishment survey may be needed before disturbing walls, ceilings, floors, boxing, ducts or service areas.",
  },
  {
    q: "Can surveys be arranged for shops and bars in Headingley?",
    a: "Yes. Survey enquiries can be arranged for retail, hospitality and commercial premises before fit-outs, strip-outs, maintenance works, tenant alterations or landlord upgrades.",
  },
  {
    q: "What asbestos materials are common in older Headingley properties?",
    a: "Common suspect materials can include textured coatings, floor tiles, bitumen adhesive, asbestos insulating board, pipe boxing, soffits, cement roof sheets and materials hidden in ceiling voids or service cupboards.",
  },
  {
    q: "How much does an asbestos survey cost in Headingley?",
    a: "Costs depend on survey type, property size, access, sampling, building complexity and whether works are planned. The asbestos survey cost guide gives typical pricing guidance.",
  },
];
...
const processSteps = [
  ...
  [
    ...
    "A qualified asbestos surveyor covering Headingley can advise whether you are likely to need a management survey, refurbishment survey, demolition survey or reinspection based on how the building is used and what work is planned.",
  ],
  [
    "03",
...
export default function HeadingleyPage() {
  return (
    <main className="min-h-screen bg-[#f6f7f3] text-slate-800">
      ...
      <Hero
        title="Asbestos Survey Headingley"
        intro="Arrange asbestos survey enquiries across Headingley, Hyde Park, Burley, Kirkstall and Woodhouse for landlords, homeowners, property buyers, student accommodation, commercial premises and refurbishment projects. Work with qualified asbestos surveyors and receive clear, compliance-focused reporting."
        mobileIntro="Arrange asbestos survey enquiries across Headingley, Hyde Park, Burley and Kirkstall for homes, landlords, student lets and planned works."
        desktopImage="/images/asbestos-surveys-hero.png"
        imageAlt="Asbestos survey Headingley"
        primaryHref="/quote"
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto grid max-w-[1120px] gap-12 md:grid-cols-[0.58fr_0.42fr]">
          <Fade>
            <InnerTitle
              center={false}
              eyebrow="LS6 / NORTH WEST LEEDS asbestos survey enquiries"
              intro={
                <p>
                  Headingley and the surrounding LS6 area include a dense mix of Victorian and Edwardian terraces, converted flats, student accommodation, larger villas, shops, pubs, offices and older institutional buildings. Many properties have been altered, extended or refurbished repeatedly, which can make asbestos survey scoping more complex than it first appears.
                </p>
              }
            >
              Asbestos Surveys for Headingley Properties
            </InnerTitle>

            <div className="space-y-5 text-[14px] leading-7 text-slate-600">
              <p>
                Across Headingley, Hyde Park, Burley, Woodhouse and Kirkstall, survey enquiries are often linked to older rental properties, HMO accommodation, converted flats, shop units, hospitality premises and buildings undergoing refurbishment or maintenance. These areas include a large number of properties built long before asbestos restrictions were introduced, as well as buildings refurbished during the decades when asbestos-containing materials were widely used.
              </p>
              <p>
                In pre-2000 buildings, asbestos may be present in textured coatings, insulation boards, old floor tiles, bitumen adhesive, pipe boxing, service cupboards, ceiling voids, roof spaces, garage materials, soffits and plant areas. Student lets and shared houses can also involve repeated maintenance work, fire safety upgrades, rewiring, bathroom replacements and kitchen refurbishments that may disturb hidden materials.
              </p>
              <p>
                Commercial premises around Headingley Lane, Otley Road, Hyde Park Corner and nearby local centres may require asbestos surveys before shop fit-outs, hospitality refurbishments, office works, signage changes, extraction alterations, ceiling replacement or landlord works.
              </p>
              <p>
                OwlSafe helps connect landlords, homeowners, property buyers, managing agents, contractors and business owners with qualified asbestos surveyors covering Headingley and wider North West Leeds.
              </p>
            </div>
            ...
            <div className="border border-[#d8e2d6] bg-[#f6f7f3] p-7 shadow-sm clip-section-bl">
              ...
              <div className="mt-6 grid gap-3">
                {[
                  ...
                  "Landlord and managed property duties",
                  "Commercial fit-outs and maintenance",
                  "Garage or outbuilding checks",
      ...
      <section className="bg-[#f6f7f3] px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          <InnerTitle
            ...
            intro={
              <p>
                Survey scope depends on the building, how it has been altered and whether the planned work is intrusive. These are some of the property types commonly linked with Headingley asbestos survey enquiries.
              </p>
            }
          >
            Property Types Commonly Surveyed in Headingley
          </InnerTitle>
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          ...
          >
            Common Reasons for Asbestos Surveys in Headingley
          </InnerTitle>
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          <InnerTitle
            intro={
              <p>
                The process is designed to be straightforward. Provide the property details and planned works, then a qualified asbestos surveyor covering Headingley can advise on the most suitable survey type.
              </p>
            }
          >
            How Asbestos Surveys Work in Headingley
          </InnerTitle>
      ...
      <section className="bg-[#eef4eb] px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          ...
          >
            Asbestos Surveys Near Headingley
          </InnerTitle>
        ...
        <div className="relative z-10 mx-auto max-w-[1120px]">
          <div className="max-w-[760px]">
            <InnerTitle center={false}>
              Frequently Asked Questions About Asbestos Surveys in Headingley
            </InnerTitle>
                ...
                >
                  ...
                  <div className="px-6 pb-6">
                    <p className="max-w-[90%] text-[14px] leading-7 text-slate-600">
                      {item.a} {item.q.includes("cost") || item.q.includes("Cost") ? "" : ""}
                    </p>
                  </div>
                </details>
              ))}
            ...
            <div className="mt-8 overflow-hidden border border-[#d8e2d6] bg-[#1b3a1f] p-7 text-white shadow-[0_20px_50px_rgba(27,58,31,0.12)] clip-section-bl">
              <h3 className="text-[28px] font-semibold leading-tight">
                Need an Asbestos Survey in Headingley?
              </h3>
              <p className="mt-4 max-w-[620px] text-[14px] leading-7 text-white/78">
                Arrange asbestos survey enquiries for homes, landlords, commercial premises and refurbishment projects across Headingley and nearby areas including Hyde Park, Burley, Kirkstall, Woodhouse and Meanwood.
              </p>
        ...
        <div className="mx-auto flex max-w-[1120px] flex-col justify-between gap-8 text-white md:flex-row md:items-center">
          <div>
            ...
            <p className="mt-4 max-w-[680px] text-[14px] leading-7 text-white/74">
              Request a quote for asbestos survey enquiries across Headingley, Hyde Park, Burley, Kirkstall, Woodhouse and Meanwood and wider Leeds.
            </p>
          </div>
