...
const buildingTypes = [
  {
    title: "Terraces and older housing",
    text: "Morley includes older terraces, post-war homes and later extended properties where asbestos may appear in ceilings, floor tiles, service boxing, garages, loft spaces and refurbishment layers.",
  },
  {
    title: "Textile, workshop and warehouse buildings",
    text: "Morley’s textile and industrial heritage means some premises include former mills, workshops, storage areas, roof voids, plant spaces and service routes that require careful survey scoping.",
  },
  {
    title: "Town centre shops and offices",
    text: "Retail, hospitality and office premises around Morley town centre may need asbestos survey information before fit-outs, lease changes, landlord works, maintenance or refurbishment.",
  },
  {
    title: "Schools, community and managed buildings",
    text: "Schools, churches, community premises, managed residential buildings and commercial properties may require management surveys, reinspections or refurbishment surveys before planned works.",
  },
];
...
const surveyReasons = [
  {
    ...
    text: "Refurbishment surveys may be required before shop fit-outs, office alterations, warehouse works, intrusive maintenance or changes to services and partitions.",
  },
  {
    title: "Landlord responsibilities",
    href: "/asbestos-management-survey-leeds",
    text: "Management surveys support duty holders responsible for commercial buildings, shared spaces, workplaces and managed residential areas.",
  },
  {
    title: "Buying or selling property",
    href: "/asbestos-surveys-leeds",
    text: "A survey can help buyers understand possible asbestos issues before committing to older homes, mixed-use buildings or commercial premises.",
  },
  {
    title: "Demolition and strip-out",
    href: "/asbestos-demolition-survey-leeds",
    text: "Demolition surveys may be needed before full or partial demolition, structural strip-out, redevelopment or removal of garages and outbuildings.",
  },
];
...
const commonMaterials = [
  ...
  "Roof voids, service ducts and commercial fit-out materials",
  "Fire protection boards around structural steel or plant areas",
];

const nearbyAreas = [
  {
    title: "Churwell",
    text: "Older residential properties, landlord enquiries and refurbishment projects.",
  },
  {
    title: "Tingley",
    text: "Homes, commercial units, garages, outbuildings and property purchase surveys.",
  },
  {
    title: "Gildersome",
    text: "Residential, industrial and commercial survey enquiries near motorway routes.",
  },
  {
    title: "Drighlington",
    text: "Older housing, workshops, garages and planned works.",
  },
  {
    title: "Beeston",
    text: "Terraces, rental properties, commercial premises and maintenance projects.",
  },
  {
    title: "Middleton",
    text: "Post-war housing, community buildings, schools and managed premises.",
  },
];

const faqsData = [
  {
    q: "Do Morley commercial buildings need asbestos surveys?",
    a: "Commercial premises built or refurbished before 2000 may need asbestos management information, especially where there are duty holder responsibilities or planned refurbishment works.",
  },
  {
    q: "What asbestos materials are common in older industrial buildings?",
    a: "Surveyors may need to check roof sheets, boards, service routes, pipe insulation, plant rooms, ceiling voids, floor tiles and fire protection materials depending on the building and works.",
  },
  {
    q: "Do I need a survey before a shop fit-out?",
    a: "If the fit-out will disturb walls, ceilings, floors, services, partitions or structural areas in a pre-2000 premises, a refurbishment survey may be needed before work starts.",
  },
  {
    q: "Can surveys be arranged for rented homes?",
    a: "Yes. Survey enquiries can be arranged for landlords, managing agents and homeowners where asbestos concerns relate to rental properties, shared areas or planned works.",
  },
  {
    q: "How much does an asbestos survey cost in Morley?",
...
const processSteps = [
  ...
  [
    ...
    "A qualified asbestos surveyor covering Morley can advise whether you are likely to need a management survey, refurbishment survey, demolition survey or reinspection based on how the building is used and what work is planned.",
  ],
  [
    "03",
...
export default function MorleyPage() {
  return (
    <main className="min-h-screen bg-[#f6f7f3] text-slate-800">
      ...
      <Hero
        title="Asbestos Survey Morley"
        intro="Arrange asbestos survey enquiries across Morley, Churwell, Tingley and nearby South Leeds areas for homeowners, landlords, commercial premises, workshops, warehouses and planned refurbishment work. Work with qualified asbestos surveyors and receive clear, compliance-focused reporting."
        mobileIntro="Arrange asbestos survey enquiries across Morley, Churwell and Tingley for homes, landlords, commercial premises and planned works."
        desktopImage="/images/asbestos-surveys-hero.png"
        imageAlt="Asbestos survey Morley"
        primaryHref="/quote"
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto grid max-w-[1120px] gap-12 md:grid-cols-[0.58fr_0.42fr]">
          <Fade>
            <InnerTitle
              center={false}
              eyebrow="LS27 / SOUTH LEEDS asbestos survey enquiries"
              intro={
                <p>
                  Morley includes older terraces, former textile buildings, workshops, warehouses, retail premises, civic buildings, post-war housing, schools and modern commercial units. Its industrial and commercial history means survey scope often needs to consider older building fabric alongside later refurbishment, service upgrades and fit-out works.
                </p>
              }
            >
              Asbestos Surveys for Morley Properties
            </InnerTitle>

            <div className="space-y-5 text-[14px] leading-7 text-slate-600">
              <p>
                Across Morley, Churwell, Tingley, Gildersome and Drighlington, asbestos survey enquiries are often linked to terraced housing, older commercial premises, workshops, warehouses, retail units, landlord properties, schools and refurbishment projects.
              </p>
              <p>
                Morley grew as an important textile town, with mills, shoddy production, workshops and commercial premises shaping much of its built environment. Older buildings and later altered premises may contain hidden materials from different phases of construction, repair, fire protection, maintenance and fit-out.
              </p>
              <p>
                Where properties were built or refurbished before 2000, asbestos-containing materials may be present in textured coatings, insulation boards, service ducts, floor tiles, pipework, boiler rooms, roof sheets, soffits, ceiling voids, partition systems and plant areas.
              </p>
              <p>
                OwlSafe helps connect homeowners, landlords, business owners, managing agents, contractors and developers with qualified asbestos surveyors covering Morley and nearby South Leeds locations.
              </p>
            </div>
          ...
          <Fade delay={0.06}>
            <div className="border border-[#d8e2d6] bg-[#f6f7f3] p-7 shadow-sm clip-section-bl">
              ...
              <h3 className="mt-5 text-[26px] font-semibold leading-tight text-[#1b3a1f]">
                Common Morley enquiries
              </h3>

              <div className="mt-6 grid gap-3">
                {[
                  "Property purchase surveys",
                  "Older terrace refurbishments",
                  "Commercial fit-outs and shop works",
                  "Workshop and warehouse surveys",
      ...
      <section className="bg-[#f6f7f3] px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          <InnerTitle
            ...
            intro={
              <p>
                Survey scope depends on the building, how it has been altered and whether the planned work is intrusive. These are some of the property types commonly linked with Morley asbestos survey enquiries.
              </p>
            }
          >
            Property Types Commonly Surveyed in Morley
          </InnerTitle>
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          ...
          >
            Common Reasons for Asbestos Surveys in Morley
          </InnerTitle>
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          <InnerTitle
            intro={
              <p>
                The process is designed to be straightforward. Provide the property details and planned works, then a qualified asbestos surveyor covering Morley can advise on the most suitable survey type.
              </p>
            }
          >
            How Asbestos Surveys Work in Morley
          </InnerTitle>
        ...
        <div className="relative z-10 mx-auto max-w-[1120px]">
          <div className="max-w-[760px]">
            <InnerTitle center={false}>
              Frequently Asked Questions About Asbestos Surveys in Morley
            </InnerTitle>
            ...
            <div className="mt-8 overflow-hidden border border-[#d8e2d6] bg-[#1b3a1f] p-7 text-white shadow-[0_20px_50px_rgba(27,58,31,0.12)] clip-section-bl">
              <h3 className="text-[28px] font-semibold leading-tight">
                Need an Asbestos Survey in Morley?
              </h3>
              <p className="mt-4 max-w-[620px] text-[14px] leading-7 text-white/78">
                Arrange asbestos survey enquiries for homes, landlords, commercial premises and refurbishment projects across Morley and nearby areas including Churwell, Tingley, Gildersome, Drighlington and Middleton.
              </p>
        ...
        <div className="mx-auto flex max-w-[1120px] flex-col justify-between gap-8 text-white md:flex-row md:items-center">
          <div>
            ...
            <p className="mt-4 max-w-[680px] text-[14px] leading-7 text-white/74">
              Request a quote for asbestos survey enquiries across Morley, Churwell, Tingley, Gildersome, Drighlington, Middleton and wider Leeds.
            </p>
          </div>
