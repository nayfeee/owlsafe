...
const buildingTypes = [
  {
    title: "Larger and period homes",
    text: "Roundhay includes many substantial homes and older properties where later refurbishments may have introduced asbestos-containing materials into ceilings, floors, services, extensions and outbuildings.",
  },
  {
    title: "Converted flats and apartments",
    text: "Converted properties and managed residential buildings may include communal areas, basements, risers, loft spaces, service cupboards and shared plant areas that require asbestos management information.",
  },
  {
    title: "Schools and community buildings",
    text: "Educational, religious and community buildings can have duty holder responsibilities and may need management surveys, reinspections or refurbishment surveys before works.",
  },
  {
    title: "Oakwood and local commercial premises",
    text: "Retail, hospitality and office premises around Oakwood and nearby centres may require surveys before fit-outs, refurbishments, strip-outs or landlord works.",
  },
];
...
const surveyReasons = [
  {
    ...
    text: "Buyers may arrange surveys before purchasing older, extended or previously refurbished homes to understand potential asbestos risks.",
  },
  {
    title: "Home extension or renovation",
    href: "/asbestos-refurbishment-survey-leeds",
    text: "Refurbishment surveys may be needed before intrusive works to ceilings, walls, floors, loft spaces, basements, garages or services.",
  },
  {
    title: "Managed building responsibilities",
    href: "/asbestos-management-survey-leeds",
    text: "Management surveys and reinspections support duty holders responsible for non-domestic premises and shared areas.",
  },
  {
    title: "Commercial or community premises work",
    href: "/asbestos-refurbishment-survey-leeds",
    text: "Surveys can be arranged before works to shops, offices, schools, churches, community buildings or hospitality premises.",
  },
];

const commonMaterials = [
  "Textured coatings and ceiling finishes",
  "Asbestos insulating board in cupboards, risers or service boxing",
  "Old floor tiles and adhesive",
  "Pipe insulation and boiler area materials",
  "Garage roof sheets and asbestos cement products",
  "Soffits and external panels",
  "Basement, loft and service void materials",
  "Fire protection boards around structural or service areas"
];

const nearbyAreas = [
  {
    title: "Oakwood",
    text: "Local shops, hospitality, period homes and refurbishment enquiries.",
  },
  {
    title: "Gledhow",
    text: "Larger homes, apartments, managed buildings and property purchase surveys.",
  },
  {
    title: "Moortown",
    text: "Residential properties, commercial units and refurbishment projects.",
  },
  {
    title: "Chapel Allerton",
    text: "Period homes, local commercial premises, larger properties and planned works.",
  },
  {
    title: "Harehills",
    text: "Older terraces, commercial units, landlords and mixed-use premises.",
  },
  {
    title: "Alwoodley",
    text: "Larger homes, extensions, garages and property purchase enquiries.",
  },
];

const faqsData = [
  {
    q: "Do period homes in Roundhay need asbestos surveys?",
    a: "Not automatically, but if a property was built or refurbished before 2000 and intrusive work is planned, an asbestos survey may be needed to check later materials such as ceilings, boards, floor tiles, boxing and services.",
  },
  {
    q: "What survey is needed before renovating a larger home?",
    a: "If works will disturb the building fabric, a refurbishment survey is usually the relevant survey type. The exact scope depends on the rooms, services and areas being affected.",
  },
  {
    q: "Can surveys be arranged for schools or community buildings?",
    a: "Yes. Survey enquiries can be arranged for schools, churches, community premises, managed buildings and other non-domestic properties where asbestos duties may apply.",
  },
  {
    q: "Are communal areas in flats covered?",
    a: "Communal areas, service risers, plant spaces, roof voids, basements and shared areas may require asbestos management information, particularly for managed residential buildings.",
  },
  {
    q: "How much does an asbestos survey cost in Roundhay?",
    a: "Costs depend on the property, survey type, access, samples and scope. The asbestos survey cost guide explains the main pricing factors.",
  },
];
...
const processSteps = [
  ...
  [
    ...
    "A qualified asbestos surveyor covering Roundhay can advise whether you are likely to need a management survey, refurbishment survey, demolition survey or reinspection based on how the building is used and what work is planned.",
  ],
  [
    "03",
...
export default function RoundhayPage() {
  return (
    <main className="min-h-screen bg-[#f6f7f3] text-slate-800">
      ...
      <Hero
        title="Asbestos Survey Roundhay"
        intro="Arrange asbestos survey enquiries across Roundhay, Oakwood, Gledhow and nearby North Leeds areas for larger homes, period properties, landlords, commercial premises and planned works. Work with qualified asbestos surveyors and receive clear, compliance-focused reporting."
        mobileIntro="Arrange asbestos survey enquiries across Roundhay, Oakwood and Gledhow for homes, landlords, commercial premises and planned works."
        desktopImage="/images/asbestos-surveys-hero.png"
        imageAlt="Asbestos survey Roundhay"
        primaryHref="/quote"
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto grid max-w-[1120px] gap-12 md:grid-cols-[0.58fr_0.42fr]">
          <Fade>
            <InnerTitle
              center={false}
              eyebrow="LS8 / NORTH EAST LEEDS asbestos survey enquiries"
              intro={
                <p>
                  Roundhay and nearby North Leeds areas include substantial period homes, inter-war housing, post-war developments, apartment conversions, managed residential buildings, schools, local shops, offices and hospitality premises. Many have been refurbished, extended or adapted during periods when asbestos materials were still in common use.
                </p>
              }
            >
              Asbestos Surveys for Roundhay Properties
            </InnerTitle>

            <div className="space-y-5 text-[14px] leading-7 text-slate-600">
              <p>
                Across Roundhay, Oakwood, Gledhow, Moortown and Chapel Allerton, asbestos survey enquiries are often linked to larger homes, period properties, converted flats, extensions, basement works, loft spaces, schools, local commercial premises and landlord-managed buildings.
              </p>
              <p>
                Where buildings were constructed or refurbished before 2000, asbestos-containing materials may be found in textured coatings, insulation boards, service cupboards, floor tiles, pipe boxing, garage roofs, soffits, ceiling voids, boiler areas and older outbuildings.
              </p>
              <p>
                Larger homes and period properties can require careful survey scoping because original building fabric may sit alongside later additions, extensions, heating upgrades, electrical works, fire protection materials and previous refurbishment layers.
              </p>
              <p>
                OwlSafe helps connect homeowners, buyers, landlords, managing agents, contractors and commercial property owners with qualified asbestos surveyors covering Roundhay and wider North Leeds.
              </p>
            </div>
      ...
      <section className="bg-[#f6f7f3] px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          <InnerTitle
            ...
            intro={
              <p>
                Survey scope depends on the building, how it has been altered and whether the planned work is intrusive. These are some of the property types commonly linked with Roundhay asbestos survey enquiries.
              </p>
            }
          >
            Property Types Commonly Surveyed in Roundhay
          </InnerTitle>
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          ...
          >
            Common Reasons for Asbestos Surveys in Roundhay
          </InnerTitle>
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          <InnerTitle
            intro={
              <p>
                The process is designed to be straightforward. Provide the property details and planned works, then a qualified asbestos surveyor covering Roundhay can advise on the most suitable survey type.
              </p>
            }
          >
            How Asbestos Surveys Work in Roundhay
          </InnerTitle>
      ...
      <section className="bg-[#eef4eb] px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          ...
          >
            Asbestos Surveys Near Roundhay
          </InnerTitle>
        ...
        <div className="relative z-10 mx-auto max-w-[1120px]">
          <div className="max-w-[760px]">
            <InnerTitle center={false}>
              Frequently Asked Questions About Asbestos Surveys in Roundhay
            </InnerTitle>
            ...
            <div className="mt-8 overflow-hidden border border-[#d8e2d6] bg-[#1b3a1f] p-7 text-white shadow-[0_20px_50px_rgba(27,58,31,0.12)] clip-section-bl">
              <h3 className="text-[28px] font-semibold leading-tight">
                Need an Asbestos Survey in Roundhay?
              </h3>
              <p className="mt-4 max-w-[620px] text-[14px] leading-7 text-white/78">
                Arrange asbestos survey enquiries for homes, landlords, commercial premises and refurbishment projects across Roundhay and nearby areas including Oakwood, Gledhow, Moortown, Chapel Allerton and Harehills.
              </p>
        ...
        <div className="mx-auto flex max-w-[1120px] flex-col justify-between gap-8 text-white md:flex-row md:items-center">
          <div>
            ...
            <p className="mt-4 max-w-[680px] text-[14px] leading-7 text-white/74">
              Request a quote for asbestos survey enquiries across Roundhay, Oakwood, Gledhow, Moortown, Chapel Allerton and Harehills and wider Leeds.
            </p>
          </div>
