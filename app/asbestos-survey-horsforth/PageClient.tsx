...
const buildingTypes = [
  {
    title: "Extended family homes",
    text: "Horsforth has many detached, semi-detached and extended homes. Survey enquiries often relate to kitchens, bathrooms, loft spaces, garages, extensions, floor finishes and heating or electrical upgrades.",
  },
  {
    title: "Older stone and period properties",
    text: "Older homes may have been upgraded many times. Asbestos materials can sometimes appear in later ceilings, boards, floor tiles, service boxing, roofline products or outbuildings rather than the original structure.",
  },
  {
    title: "Garages and outbuildings",
    text: "Garage roofs, lean-tos, sheds and external panels may include asbestos cement products, particularly where buildings were added or altered during the mid-to-late twentieth century.",
  },
  {
    title: "Local commercial premises",
    text: "Shops, offices, schools, community buildings and hospitality premises may need management or refurbishment surveys before planned works or routine maintenance.",
  },
];
...
const surveyReasons = [
  {
    ...
    text: "Buyers may request a survey to understand potential asbestos risks before committing to an older or previously refurbished property.",
  },
  {
    title: "Before home refurbishment",
    href: "/asbestos-refurbishment-survey-leeds",
    text: "Refurbishment surveys may be required before intrusive work such as rewiring, extensions, garage conversions, kitchen works or bathroom replacement.",
  },
  {
    title: "For landlords and managed premises",
    href: "/asbestos-management-survey-leeds",
    text: "Management surveys help duty holders understand asbestos risks in occupied premises and areas requiring maintenance.",
  },
  {
    title: "Before demolition or strip-out",
    href: "/asbestos-demolition-survey-leeds",
    text: "Demolition surveys are used before full demolition, major strip-out or removal of structures where asbestos could be disturbed.",
  },
];

const commonMaterials = [
  "Textured coatings in older ceilings",
  "Asbestos insulating board in cupboards or boxing",
  "Floor tiles and bitumen adhesive",
  "Garage roof sheets and asbestos cement panels",
  "Soffits, gutters and roofline products",
  "Pipe insulation and service ducts",
  "Loft, extension and partition materials",
  "Plant room or boiler area materials"
];

const nearbyAreas = [
  {
    title: "Cookridge",
    text: "Suburban homes, extensions, garages and property purchase enquiries.",
  },
  {
    title: "Rawdon",
    text: "Older homes, larger properties, commercial premises and refurbishment works.",
  },
  {
    title: "Woodside",
    text: "Residential properties, garages, maintenance and landlord enquiries.",
  },
  {
    title: "West Park",
    text: "Family homes, older properties, school and commercial premises nearby.",
  },
  {
    title: "Bramley",
    text: "Mixed residential stock, commercial premises and refurbishment projects.",
  },
  {
    title: "Kirkstall",
    text: "Apartments, older buildings, student accommodation and commercial survey enquiries.",
  },
];

const faqsData = [
  {
    q: "Do older homes in Horsforth need asbestos surveys?",
    a: "Not every older property contains asbestos, but homes built or refurbished before 2000 may contain asbestos-containing materials. A survey is commonly arranged before intrusive refurbishment, purchase due diligence or demolition work.",
  },
  {
    q: "Could a garage roof in Horsforth contain asbestos?",
    a: "Yes, many older garage roofs and outbuildings across Leeds used asbestos cement sheets. Condition, disturbance and planned removal affect what action may be required.",
  },
  {
    q: "What survey is needed before a kitchen or bathroom renovation?",
    a: "If the work will disturb walls, floors, ceilings, boxing or service routes in a pre-2000 property, a refurbishment survey may be required before work starts.",
  },
  {
    q: "Can commercial premises in Horsforth be surveyed?",
    a: "Yes. Survey enquiries can be arranged for shops, offices, schools, hospitality units, community premises and managed commercial buildings.",
  },
  {
    q: "How much does an asbestos survey cost in Horsforth?",
...
const processSteps = [
  ...
  [
    ...
    "A qualified asbestos surveyor covering Horsforth can advise whether you are likely to need a management survey, refurbishment survey, demolition survey or reinspection based on how the building is used and what work is planned.",
  ],
  [
    "03",
...
export default function HorsforthPage() {
  return (
    <main className="min-h-screen bg-[#f6f7f3] text-slate-800">
      ...
      <Hero
        title="Asbestos Survey Horsforth"
        intro="Arrange asbestos survey enquiries across Horsforth, Cookridge, Rawdon and nearby North West Leeds areas for homeowners, landlords, property buyers, commercial premises and planned refurbishment work. Work with qualified asbestos surveyors and receive clear, compliance-focused reporting."
        mobileIntro="Arrange asbestos survey enquiries across Horsforth, Cookridge and Rawdon for homes, landlords, commercial premises and planned works."
        desktopImage="/images/asbestos-surveys-hero.png"
        imageAlt="Asbestos survey Horsforth"
        primaryHref="/quote"
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto grid max-w-[1120px] gap-12 md:grid-cols-[0.58fr_0.42fr]">
          <Fade>
            <InnerTitle
              center={false}
              eyebrow="LS18 / NORTH WEST LEEDS asbestos survey enquiries"
              intro={
                <p>
                  Horsforth contains a broad mix of older stone properties, inter-war and post-war housing, extended family homes, converted premises, local shops, schools, offices and light commercial buildings. Many properties have been modernised over time, and asbestos-containing materials may have been introduced during later alterations or refurbishment.
                </p>
              }
            >
              Asbestos Surveys for Horsforth Properties
            </InnerTitle>

            <div className="space-y-5 text-[14px] leading-7 text-slate-600">
              <p>
                Across Horsforth, Cookridge, Rawdon, Woodside and surrounding parts of North West Leeds, asbestos survey enquiries are commonly linked to property purchases, extensions, garage conversions, kitchen and bathroom works, rewiring, roofline works, commercial fit-outs and landlord maintenance.
              </p>
              <p>
                Although some older Horsforth properties pre-date the main period of asbestos use, later upgrades from the 1950s through to the late 1990s may have added asbestos-containing materials within ceilings, floors, service areas, garages, extensions, partition walls, pipe boxing and outbuildings.
              </p>
              <p>
                Local commercial premises around Town Street, New Road Side, Low Lane and nearby business areas may need asbestos survey information before tenant fit-outs, maintenance, refurbishment, change-of-use works or landlord improvements.
              </p>
              <p>
                OwlSafe helps connect homeowners, buyers, landlords, managing agents, contractors and business owners with qualified asbestos surveyors covering Horsforth and nearby North West Leeds locations.
              </p>
            </div>
      ...
      <section className="bg-[#f6f7f3] px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          <InnerTitle
            ...
            intro={
              <p>
                Survey scope depends on the building, how it has been altered and whether the planned work is intrusive. These are some of the property types commonly linked with Horsforth asbestos survey enquiries.
              </p>
            }
          >
            Property Types Commonly Surveyed in Horsforth
          </InnerTitle>
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          ...
          >
            Common Reasons for Asbestos Surveys in Horsforth
          </InnerTitle>
      ...
      <section className="bg-white px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          <InnerTitle
            intro={
              <p>
                The process is designed to be straightforward. Provide the property details and planned works, then a qualified asbestos surveyor covering Horsforth can advise on the most suitable survey type.
              </p>
            }
          >
            How Asbestos Surveys Work in Horsforth
          </InnerTitle>
      ...
      <section className="bg-[#eef4eb] px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[1120px]">
          ...
          >
            Asbestos Surveys Near Horsforth
          </InnerTitle>
        ...
        <div className="relative z-10 mx-auto max-w-[1120px]">
          <div className="max-w-[760px]">
            <InnerTitle center={false}>
              Frequently Asked Questions About Asbestos Surveys in Horsforth
            </InnerTitle>
            ...
            <div className="mt-8 overflow-hidden border border-[#d8e2d6] bg-[#1b3a1f] p-7 text-white shadow-[0_20px_50px_rgba(27,58,31,0.12)] clip-section-bl">
              <h3 className="text-[28px] font-semibold leading-tight">
                Need an Asbestos Survey in Horsforth?
              </h3>
              <p className="mt-4 max-w-[620px] text-[14px] leading-7 text-white/78">
                Arrange asbestos survey enquiries for homes, landlords, commercial premises and refurbishment projects across Horsforth and nearby areas including Cookridge, Rawdon, Woodside, West Park and Bramley.
              </p>
        ...
        <div className="mx-auto flex max-w-[1120px] flex-col justify-between gap-8 text-white md:flex-row md:items-center">
          <div>
            ...
            <p className="mt-4 max-w-[680px] text-[14px] leading-7 text-white/74">
              Request a quote for asbestos survey enquiries across Horsforth, Cookridge, Rawdon, Woodside, West Park and Bramley and wider Leeds.
            </p>
          </div>
